...
public class PrintUtilsTest {
    ...
    void printableDeveAceitarPrimeiraPaginaERejeitarDemais() throws PrinterException {
        // 1) Dados fictícios para criar o Printable
        ...
        // 2) Preenche arrays de imagens, refs e pastas
        BufferedImage[] imagens = new BufferedImage[5];
        for (int i = 0; i < imagens.length; i++) {
            // criamos um bitmap pequeno só para exercitar o print
        ...
        // 6) Página 1 (e seguintes) não devem existir
